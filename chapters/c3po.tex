...
On top, there is a simple controller, that uses the components below to carry out the work flow. 
...
For these reasons the data model was analysed again and different storage possibilities were evaluated. 
